...
// Per-IP rate limiting (makeRateLimiter, makeCostRateLimiter, the OpenAI/Google
// cost limiters, clientKey, enforceOptInRateLimit) and the preview-server opt-in
// gate (installOnPreviewIfEnabled) moved to server/rateLimit.js and
// server/previewGate.js (#41).
...
// Radio Browser directory proxy (`/api/radio`) moved to server/radioBrowserProxy.js (#41).
// ---------------------------------------------------------------------------
